...
public enum AdicionarPaisText {
    ...
    LBL_SUCCESS_TEXT("País cadastrado com sucesso!"), LBL_ERROR_TEXT("Erro ao cadastrar país!"),
    LBL_ERROR_EMPTY_FIELD("Preencha todos os campos!"), LBL_ERROR_EXISTING("País já cadastrado!"),
    LBL_NOME("Nome:"), LBL_CAPITAL("Capital:"),
    LBL_DIMENSION("Dimensao:"), BTN_SAVE("Salvar"), BTN_MENU("Menu");
